class CreateDatabaseStructure < ActiveRecord::Migration[5.2]
  def change
    ...
    create_table "applicationroles", primary_key: "applicationroleid", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
      t.string "applicationrolename", limit: 45
    end
	
	create_table "applicationusers", primary_key: "applicationuserid", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    create_table "applicationuserinroles", primary_key: "applicationuserinroleid", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    create_table "courses", primary_key: "courseid", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
      t.string "name", limit: 100
      t.string "description", limit: 500
    end
	
    create_table "roles", primary_key: "rolesid", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
      t.string "rolename", limit: 45
    end
	
	create_table "employees", primary_key: "employeeid", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
      t.string "firstname", limit: 45
      t.string "lastname", limit: 45
	...
	create_table "versions", primary_key: "versionid", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
      t.string "versionname", limit: 45
      t.datetime "createddatetime", default: -> { "CURRENT_TIMESTAMP" }
    end
	
    create_table "coursesforroles", primary_key: "coursesforroleid", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
      t.integer "course_id"
      t.integer "role_id"
    ...
    create_table "courseversions", primary_key: "courseversionid", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
      t.integer "course_id"
    ...
    create_table "employeeroles", primary_key: "employeerolesid", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    create_table "trainingevents", primary_key: "trainingeventid", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    create_table "eventattendees", primary_key: "eventattendeesid", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
